...
function SignIn() {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      setErr("Google authentication not implemented yet")
    } catch (error) {
      console.log(error)
    }
  }
  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
        ...
        <h1 className={`text-3xl font-bold mb-2 `} style={{ color: primaryColor }}>Peepzza</h1>
        <p className='text-gray-600 mb-2'> Sign In to your account to get started with delicious food deliveries</p>
